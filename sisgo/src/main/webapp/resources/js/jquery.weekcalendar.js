...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      _refreshEventDetails : function(calEvent, $calEvent) {
         ...
         $calEvent.find(".wc-title").html(calEvent.patient);
   ...
   $.extend($.ui.weekCalendar, {
      ...
      defaults: {
         ...
         longMonths : ['Janeiro', 'Fevereiro', 'Marco', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Oututro', 'Novembro', 'Dezembro'],
